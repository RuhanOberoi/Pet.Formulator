...
// ─── VERCEL CONFIG ───
// Tell Vercel this function may take longer than the default.
// On Hobby plan: caps at 10s regardless of this value (free plan limit).
// On Pro plan: allows up to 60s by default, up to 300s with this config.
// Once you upgrade to Pro, this config will automatically grant longer timeouts.
export const config = {
  maxDuration: 60,
};
